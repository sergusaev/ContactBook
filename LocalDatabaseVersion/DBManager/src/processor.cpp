...
//DBTypes::DBResult Processor::updateDataRecord(DBTypes::DBTables table, const DBTypes::DBEntry &oldRecordData, const DBTypes::DBEntry &updatedRecordData)
//{
//    return m_d->manipulator.updateRow(tableMapper.at(table), oldRecordData, updatedRecordData);
//}
}
